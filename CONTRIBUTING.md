# Contributing to `eslint-plugin-prefer-smart-quotes`
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/eslint-plugin-prefer-smart-quotes
   # Navigate to the newly cloned directory
   cd eslint-plugin-prefer-smart-quotes
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/<project-username>/eslint-plugin-prefer-smart-quotes
   ```
